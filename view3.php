...
<div class="container-fluid">
    ...
    <div class="container">
        ...
        <h2>Dengue Page Mailing List Subscribers </h2>
        <button onclick="window.location.href= 'create3.php';" type="button" class="btn btn-primary btn-lg">Create new subscriber</button>
...
<table class="table table-bordered" id="table4">
    ...
    <tbody> 
        ...
        ?>
                    ...
                    <td><a class="btn btn-danger" href="delete3.php?id=<?php echo $row['id']; ?>">Unsubscribe</a></td>
