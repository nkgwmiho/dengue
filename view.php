...
<div class="container-fluid">
            ...
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <div class="dropdown pb-4">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                        ...
                        <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#exampleModal">Logout</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <h2>Type of Dengue Cases</h2>
        <button onclick="window.location.href= 'create.php';" type="button" class="btn btn-primary btn-lg">Create new type of Case</button>
...
<table class="table table-bordered" id="table2">
    ...
    <tbody> 
        ...
        ?>
                    ...
                    <td><?php echo $row['yearOfCase']; ?></td>

                    <td><?php echo $row['weekOfCase']; ?></td>

                    <td><?php echo $row['type']; ?></td>

                    <td><?php echo $row['numberOfCase']; ?></td>

                    

                    <td><a class="btn btn-info" href="update.php?id=<?php echo $row['typeID']; ?>">Edit</a>&nbsp;<a class="btn btn-danger" href="delete.php?id=<?php echo $row['typeID']; ?>">Delete</a></td>
